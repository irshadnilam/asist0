/**
 * AI Agent Orb — WebGL animated orb based on reactbits.dev/backgrounds/orb
 * Modified for IDE dark theme with idle/active states.
 *
 * - Idle: dim, slow rotation, subtle glow
 * - Active: bright, energized pulse, faster animation
 * - Click to toggle
 *
...
export default function Orb({ active = false, onToggle, size = 64 }: OrbProps) {
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      // Smoothly interpolate hover (active = energized distortion)
      ...
      // Hue shifts slightly when active (more cyan/electric)
      const targetHue = isActive ? 190 : 210
